...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "The present is theirs; the future, for which we have really worked, is ours.";
        CTransaction txNew;
        txNew.nTime = 1499648400;  // UTC: Monday 10th July 2017 01:00:00 AM
        txNew.vin.resize(1);
        txNew.vout.resize(1);
