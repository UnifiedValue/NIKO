...
#if defined(NDEBUG)
# error "NIKO cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "NIKO Signed Message:\n";
...
if(pindexBest->nHeight+1 >= 1 && pindexBest->nHeight+1 <= 10)
        {
            nSubsidy = 100000000 * COIN; // 1B coins
        }
...
static const int64_t nTargetTimespan = 6 * 60;  // 6 mins
